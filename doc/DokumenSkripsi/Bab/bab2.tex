...
Setelah \textit{login}, pengguna akan menemui beberapa menu, tergantung apakah pengguna adalah mahasiswa, staf TU, dll. Tampilan halaman login pada web BlueTape dapat dilihat pada Gambar \ref{fig:bluetape_login}.
...
Pengguna dapat menekan tombol "Ekspor ke XLS" untuk mendapatkan jadwal tersebut dalam format XLS, yang kemudian dapat disimpan atau dicetak. Tampilan halaman lihat jadwal dosen pada web BlueTape dapat dilihat pada Gambar \ref{fig:bluetape_lihat_jadwal_dosen}.
...
Tampilan halaman manajemen perubahan kuliah pada web BlueTape dapat dilihat pada Gambar \ref{fig:bluetape_manajemen_perubahan_kuliah}.
...
Tampilan halaman manajemen cetak transkrip pada web BlueTape dapat dilihat pada Gambar \ref{fig:bluetape_manajemen_cetak_transkrip}.
