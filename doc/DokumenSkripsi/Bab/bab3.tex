...
Kriteria ini tidak sukses dipatuhi karena setiap komponen masukan yang memiliki label yang menyertakan teks, nama komponen tersebut tidak mengandung teks yang disajikan secara visual. Contohnya dapat dilihat pada potongan kode \ref{lst:2.5.3_teks_label_pada_nama}.
